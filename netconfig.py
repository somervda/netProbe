        ...
        with open(self.CONFIG_FILE, "r") as configFile:
            ...
            if "useWiFi" in network:
                ...
                if self.wifiPassword == "" or self.wifiSSID == "":
                    print("Missing wifiSSID or wifiPassword settings in netconfig.json")
            else:
                print("Missing useWifi setting in netconfig.json")
            if "IP" in network:
                self.IP = network["IP"]
            ...
            if "dhcp" in network:
                ...
                print("Missing dhcp setting in netconfig.json")
